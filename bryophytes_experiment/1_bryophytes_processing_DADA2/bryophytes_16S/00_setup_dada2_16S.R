...
data.fp <- "/lustre/BIF/nobackup/berda001/novaseq_data/bryophytes/16S"
...
project.fp <- "/lustre/BIF/nobackup/berda001/ernakovich_lab_pipeline/bryophytes_project_folder_16S" # CHANGE ME to project directory; don't append with a "/"
