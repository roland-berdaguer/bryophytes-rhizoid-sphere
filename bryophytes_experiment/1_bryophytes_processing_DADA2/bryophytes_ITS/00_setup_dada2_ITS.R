...
data.fp <- "/lustre/BIF/nobackup/berda001/novaseq_data/seq4/bryophytes_ITS"
...
project.fp <- "/lustre/BIF/nobackup/berda001/ernakovich_lab_pipeline/bryophytes_ITS" # CHANGE ME to project directory; don't append with a "/"
